...
namespace Engine.Factories
{
    ...
    {
        //single backslash is an escape sequence, need two backslashes to signify an actual backslash 
        private const string GAME_DATA_FILENAME = "D:\\Projects\\XAML-and-csharp-Beginner-RPG\\Engine\\GameData\\GameItems.xml";
